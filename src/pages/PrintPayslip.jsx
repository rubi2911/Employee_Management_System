...
<th className="text-right py-3 px-4 text-xs text-slate-500 uppercase tracking-wider">Amount</th>
          ...
          <tbody>
            <tr className="border-t border-slate-100">
              ...
              <td className="text-right py-3 px-4 text-xs text-slate-900 font-medium">${payslip.basicSalary?.toLocaleString()}</td>
            </tr>
            <tr className="border-t border-slate-100">
              <td className="py-3 px-4 text-slate-700">Allowances</td>
              <td className="text-right py-3 px-4 text-xs text-slate-900 font-medium">+${payslip.allowances?.toLocaleString()}</td>
            </tr>
            <tr className="border-t border-slate-100">
              <td className="py-3 px-4 text-slate-700">Deductions</td>
              <td className="text-right py-3 px-4 text-xs text-slate-900 font-medium">-${payslip.deductions?.toLocaleString()}</td>
            </tr>
